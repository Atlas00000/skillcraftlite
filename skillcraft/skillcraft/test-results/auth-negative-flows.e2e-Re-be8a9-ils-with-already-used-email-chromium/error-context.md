...
- Name: Registration fails with already used email
- Location: /Users/celestineemili/Desktop/CodeRoot/lastfronttest/skillcraft/apps/client/tests/auth-negative-flows.e2e.spec.ts:43:5
...
Call log:
  - navigating to "http://localhost:3000/signup", waiting until "load"
    ...
    at /Users/celestineemili/Desktop/CodeRoot/lastfronttest/skillcraft/apps/client/tests/auth-negative-flows.e2e.spec.ts:44:14
```
