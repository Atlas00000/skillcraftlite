...
- Name: Forgot password flow shows success
- Location: /Users/celestineemili/Desktop/CodeRoot/lastfronttest/skillcraft/apps/client/tests/auth.e2e.spec.ts:37:5
...
Call log:
  - navigating to "http://localhost:3000/forgot-password", waiting until "load"
    ...
    at /Users/celestineemili/Desktop/CodeRoot/lastfronttest/skillcraft/apps/client/tests/auth.e2e.spec.ts:38:14
```
