...
- Location: /Users/celestineemili/Desktop/CodeRoot/lastfronttest/skillcraft/apps/client/tests/auth-negative-flows.e2e.spec.ts:52:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/reset-password?token=invalidtoken
Call log:
  - navigating to "http://localhost:3000/reset-password?token=invalidtoken", waiting until "load"

    at /Users/celestineemili/Desktop/CodeRoot/lastfronttest/skillcraft/apps/client/tests/auth-negative-flows.e2e.spec.ts:53:14
```
