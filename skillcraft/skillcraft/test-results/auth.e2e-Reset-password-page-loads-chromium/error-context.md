...
- Location: /Users/celestineemili/Desktop/CodeRoot/lastfronttest/skillcraft/apps/client/tests/auth.e2e.spec.ts:45:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/reset-password?token=dummytoken
Call log:
  - navigating to "http://localhost:3000/reset-password?token=dummytoken", waiting until "load"

    at /Users/celestineemili/Desktop/CodeRoot/lastfronttest/skillcraft/apps/client/tests/auth.e2e.spec.ts:46:14
```
